    ...
    def __init__(self):
        ...
        self._translations: dict[str, dict[str, str]] = {
            "tr": {
                ...
                "Corpus": "Korpus",
                "Browse a built-in sample text corpus.": "Yerleşik örnek metin korpusunu incele.",
                "Corpus Viewer": "Derlem Görüntüleyici",
                "Inspect corpus documents.": "Derlem belgelerini incele.",
                "Import Documents": "Belgeleri İçe Aktar",
                "Import local text files and folders into a corpus.": "Yerel metin dosyalarını ve klasörleri korpusa aktar.",
                ...
                "Apply preprocessing operations to a text corpus.": "Bir metin korpusuna ön işleme işlemleri uygula.",
                "Bag of Words": "Kelime Torbası",
                "Convert a corpus into a document-term matrix.": "Bir korpusu belge-terim matrisine dönüştür.",
                "Summarize corpus statistics.": "Derlem istatistiklerini özetle.",
                "Word List": "Kelime Listesi",
                "List words and frequencies in a corpus.": "Derlemdeki kelimeleri ve frekansları listele.",
                "Word Cloud": "Kelime Bulutu",
                "Visualize frequent corpus words.": "Derlemde sık geçen kelimeleri görselleştir.",
                "Extract Keywords": "Anahtar Kelime Çıkarma",
                "Extract keywords from corpus documents.": "Derlem belgelerinden anahtar kelimeler çıkar.",
                "Sentiment Analysis": "Duygu Analizi",
                "Score document sentiment with a lightweight lexicon.": "Belgelerin duygu durumunu hafif bir sözlükle puanla.",
                "Topic Modelling": "Konu Modellemesi",
                "Discover topics in a corpus.": "Derlemdeki konuları keşfet.",
                "Document Map": "Belge Haritası",
                "Highlight countries mentioned in the corpus on a world map.": (
                    "Derlemde geçen ülkeleri dünya haritasında vurgula."
                ),
                "PCA": "PCA",
