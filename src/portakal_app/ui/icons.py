...
def _make_custom_icon(icon_name: str) -> QIcon | None:
    ...
    if icon_name == "index":
        ...
        painter.drawLine(QPointF(16, 16), QPointF(20, 20))

    elif icon_name == "distancetransformation":
        painter.drawEllipse(QRectF(4, 4, 7, 7))
        painter.drawEllipse(QRectF(13, 13, 7, 7))
        painter.drawLine(QPointF(10, 10), QPointF(14, 14))
        painter.drawLine(QPointF(12, 6), QPointF(20, 6))
        painter.drawLine(QPointF(20, 6), QPointF(17, 3))
        painter.drawLine(QPointF(20, 6), QPointF(17, 9))

    elif icon_name == "outliers":
        painter.drawEllipse(QRectF(4, 8, 5, 5))
        painter.drawEllipse(QRectF(10, 8, 5, 5))
        painter.drawEllipse(QRectF(16, 8, 5, 5))
        painter.setBrush(accent)
        painter.drawEllipse(QRectF(10, 2, 5, 5))

    elif icon_name == "dbscan":
        painter.drawEllipse(QRectF(4, 5, 4, 4))
        painter.drawEllipse(QRectF(8, 9, 4, 4))
        painter.drawEllipse(QRectF(6, 14, 4, 4))
        painter.drawEllipse(QRectF(14, 7, 4, 4))
        painter.drawEllipse(QRectF(17, 12, 4, 4))
        painter.drawEllipse(QRectF(13, 16, 4, 4))
        painter.drawLine(QPointF(8, 8), QPointF(10, 10))
        painter.drawLine(QPointF(10, 13), QPointF(8, 16))
        painter.drawLine(QPointF(15, 9), QPointF(18, 13))
        painter.drawEllipse(QRectF(2, 3, 11, 17))
        painter.drawEllipse(QRectF(11, 5, 11, 17))

    elif icon_name == "ca":
        painter.drawLine(QPointF(4, 18), QPointF(20, 18))
        painter.drawLine(QPointF(4, 18), QPointF(4, 4))
        painter.setBrush(QColor("#3b82f6"))
        painter.drawEllipse(QRectF(6, 11, 4, 4))
        painter.drawEllipse(QRectF(10, 7, 4, 4))
        painter.drawEllipse(QRectF(15, 5, 4, 4))
        painter.setBrush(QColor("#e07020"))
        painter.drawEllipse(QRectF(7, 4, 4, 4))
        painter.drawEllipse(QRectF(12, 12, 4, 4))
        painter.drawEllipse(QRectF(17, 15, 4, 4))

    elif icon_name == "mds":
        painter.drawRect(QRectF(4, 4, 16, 16))
        painter.drawEllipse(QRectF(6, 14, 4, 4))
        painter.drawEllipse(QRectF(9, 8, 4, 4))
        painter.drawEllipse(QRectF(15, 6, 4, 4))
        painter.drawEllipse(QRectF(14, 14, 4, 4))
        painter.drawLine(QPointF(8, 16), QPointF(11, 10))
        painter.drawLine(QPointF(11, 10), QPointF(17, 8))
        painter.drawLine(QPointF(11, 10), QPointF(16, 16))
...
def get_widget_icon(icon_name: str):
    asset_path = Path(__file__).resolve().parent / "assets" / f"{icon_name}.svg"
    if asset_path.exists():
        return QIcon(str(asset_path))
    shared_icon_path = Path(__file__).resolve().parents[1] / "icons" / f"{icon_name}.svg"
    if shared_icon_path.exists():
        return QIcon(str(shared_icon_path))
